...
contenttextfield.setBounds(10, 82, 269, 130);
		...
		btnBlockParent.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
			    Message  msg=new Message("Insert into messages values ("+id_message+","+Client.client.user.getID()+",blociking parent,"+contenttextfield.getText()+","+now+",1);",QTypes.blockparent2); // updating DB messages .
